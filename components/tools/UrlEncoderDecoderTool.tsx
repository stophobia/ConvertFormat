...
import { transformUrl } from '../../utils/transformers';
...
export const UrlEncoderDecoderTool: React.FC<UrlEncoderDecoderToolProps> = ({ tabState, updateTabState }) => {
  ...
  const handleProcess = useCallback(() => {
    ...
    try {
      const result = transformUrl(tabState.input, direction);
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-2">
        ...
        <div role="radiogroup" aria-label="URL 작업" className="flex space-x-1">
            <button
                role="radio"
