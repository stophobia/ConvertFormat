...
import { transformBase64 } from '../../utils/transformers';
...
export const Base64Tool: React.FC<Base64ToolProps> = ({ tabState, updateTabState }) => {
  ...
  const handleProcess = useCallback(() => {
    ...
    try {
      const result = transformBase64(tabState.input, direction);
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-2">
        ...
        <div role="radiogroup" aria-label="Base64 작업" className="flex space-x-1">
            <button
                role="radio"
